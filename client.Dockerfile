...
CMD ["sh", "-c", "npx prisma@5.21.0 db push --schema=backend-monorepo/libs/database/prisma/schema.prisma --accept-data-loss && node backend-monorepo/dist/apps/client-api/main.js"]
