...
import { Menu, X, User, History, CreditCard, Settings, HelpCircle, LogOut, Home, Gift } from 'lucide-react'
        ...
        <div className="dashboard-container">
            ...
            <aside className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
                <div className="sidebar-header">
                    <div className="user-profile">
                        <div className="avatar-circle pink shadow">
                ...
                <nav className="sidebar-nav">
                    <button className="nav-item active">
                        <Home size={20} /> <span>Ínicio</span>
                    </button>
                    <button className="nav-item">
                        <History size={20} /> <span>Minhas Viagens</span>
                    </button>
                    <button className="nav-item">
                        <CreditCard size={20} /> <span>Pagamentos</span>
                    </button>
                    <button className="nav-item">
                        <Gift size={20} /> <span>Promoções</span>
                    </button>
                    <button className="nav-item">
                        <Settings size={20} /> <span>Configurações</span>
                    </button>
                    <button className="nav-item">
                        <HelpCircle size={20} /> <span>Ajuda</span>
                    </button>
                </nav>

                <div className="sidebar-footer">
                    <button className="btn-logout-sidebar" onClick={signOut}>
            ...
            <main className="dashboard-content">
                <div className="welcome-banner">
                    <h2>Olá, {user?.full_name?.split(' ')[0] || 'Usuário'}!</h2>
                    <p>
